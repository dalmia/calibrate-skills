...
| Agents | [connect-agent](skills/agents/connect-agent/) | Connect/create an agent (or add a Calibrate route to a codebase, inferring auth) and verify its connection |
